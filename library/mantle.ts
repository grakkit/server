...
//@ts-expect-error
const Block: InstanceClass<obbBlock> = type('org.bukkit.block.Block');
//@ts-expect-error
const BlockStateMeta: InstanceClass<obimBlockStateMeta> = type('org.bukkit.inventory.meta.BlockStateMeta');
const BoundingBox = type('org.bukkit.util.BoundingBox');
//@ts-expect-error
const CommandSender: InstanceClass<obcCommandSender> = type('org.bukkit.command.CommandSender');
//@ts-expect-error
const Entity: InstanceClass<obeEntity> = type('org.bukkit.entity.Entity');
...
//@ts-expect-error
const LivingEntity: InstanceClass<obeLivingEntity> = type('org.bukkit.entity.LivingEntity');
...
//@ts-expect-error
const OfflinePlayer: InstanceClass<obOfflinePlayer> = type('org.bukkit.OfflinePlayer');
//@ts-expect-error
const PersistentDataHolder: InstanceClass<obpPersistentDataHolder> = type(
...
const server = type('org.bukkit.Bukkit').getServer();
